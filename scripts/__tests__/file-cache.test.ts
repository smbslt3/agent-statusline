...
describe('file-cache', () => {
  ...
  describe('cleanupExpiredCache', () => {
    ...
    it('removes expired files for all cleanable prefixes', async () => {
      const targets = [
        'cache-old.json',
    ...
    it('preserves non-matching files (e.g., other-cache.json)', async () => {
      const protectedFile = path.join(tmpDir, 'other-cache.json');
